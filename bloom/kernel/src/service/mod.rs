...
mod find_group_by_namespace_id_unauthenticated;
...
mod find_upload;
mod find_user_by_namespace_id_unauthenticated;
...
#[derive(Debug, Clone)]
pub struct UpdateMyAvatarInput {
    pub avatar: Vec<u8>,
}

#[derive(Debug, Clone)]
pub struct UpdateGroupAvatarInput {
    pub group_id: Uuid,
    pub avatar: Vec<u8>,
}

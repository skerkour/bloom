...
// Billing
pub const STORAGE_FREE: i64 = 50_000_000; // 50MB
pub const STORAGE_STARTER: i64 = 100_000_000_000; // 100GB
pub const STORAGE_PRO: i64 = 1_000_000_000_000; // 1000GB
...
pub const AVATAR_MAX_SIZE: usize = 2_000_000; // 2MB
pub const AVATAR_SIZE: usize = 300;
pub const AVATAR_JPEG_QUALITY: u8 = 85;

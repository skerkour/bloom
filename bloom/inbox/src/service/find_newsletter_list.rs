...
use crate::{service::NewsletterListWithContactsAndMessages, Error, Service};
use kernel::Actor;
...
impl Service {
    pub async fn find_newsletter_list(
    ...
    ) -> Result<NewsletterListWithContactsAndMessages, kernel::Error> {
        ...
        Ok(NewsletterListWithContactsAndMessages {
            list,
            contacts,
            messages,
        })
